                        ...
                        <Link
                            ...
                            className={ `${
                                activePage === menu.slug && activePath === menu.path
                                    ? ' border-wpcolor text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'
                                    : 'border-transparent  hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'
                            }` }
                        >
                            { menu.name }
                        </Link>
